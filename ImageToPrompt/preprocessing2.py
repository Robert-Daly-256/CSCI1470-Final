...
def load_data(data_folder):
    ...
    unk_captions(train_captions, 10) # changed from 50
    unk_captions(test_captions, 10) # changed from 50
...
def create_pickle(data_folder):
    with open(f'{data_folder}/data_vocab10.p', 'wb') as pickle_file:
        pickle.dump(load_data(data_folder), pickle_file)
    print(f'Data has been dumped into {data_folder}/data_vocab10.p!')
...
if __name__ == '__main__':
    ...
    data_folder = '/Users/annieherring/Documents/s2025/dl/hw4-imagecaptioning-aherring62/data'
